...
export function Footer() {
  return <footer className="footer">
    <div className="shell footer-grid">
      ...
      <div><strong>About MotoIndex</strong><Link href="/about">About</Link><Link href="/authors/erwin-valles">Author: Erwin Valles</Link><Link href="/methodology">Methodology</Link><Link href="/data-sources">Data sources</Link><Link href="/editorial-policy">Editorial policy</Link><Link href="/affiliate-disclosure">Affiliate disclosure</Link><Link href="/privacy">Privacy</Link><Link href="/corrections">Corrections</Link><Link href="/contact">Contact</Link></div>
    </div>
