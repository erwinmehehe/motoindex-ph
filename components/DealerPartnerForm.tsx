...
export function DealerPartnerForm({initialCity="",initialProvince="",initialPlan="free",sourcePath=""}:Props){
  ...
  return <form className="lead-form dealer-partner-form" onSubmit={submit} aria-live="polite">
    ...
    <fieldset className="dealer-brand-fieldset"><legend>Listing preference</legend><div className="dealer-brand-checks">
      <label><input type="radio" name="listingPlan" value="free" defaultChecked={initialPlan!=="featured"}/><span>Free Verified Listing · ₱0</span></label>
      <label><input type="radio" name="listingPlan" value="featured" defaultChecked={initialPlan==="featured"}/><span>Featured Dealer interest · paid visibility</span></label>
    ...
    <div className="lead-form-grid">
      ...
      <label><span>City</span><input name="city" required defaultValue={initialCity}/></label>
      <label><span>Province</span><input name="province" required defaultValue={initialProvince}/></label>
