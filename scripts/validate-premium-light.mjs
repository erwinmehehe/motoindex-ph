...
requireText(layout, 'import "./premium-light-sticky-fix.css";', "Premium light sticky navigation fix must stay loaded.");
requireText(layout, 'import "./premium-light-qa-fixes.css";', "Premium light QA overrides must stay loaded.");
requireText(layout, 'import "./premium-light-final-fixes.css";', "Final premium light contrast fixes must stay loaded.");
...
if (layout.indexOf('import "./premium-light-sticky-fix.css";') < layout.indexOf('import "./premium-light-fixes.css";')) errors.push("Sticky navigation fix must load after premium light overrides.");
if (layout.indexOf('import "./premium-light-qa-fixes.css";') < layout.indexOf('import "./premium-light-sticky-fix.css";')) errors.push("QA fixes must load after sticky fixes.");
if (layout.indexOf('import "./premium-light-final-fixes.css";') < layout.indexOf('import "./premium-light-qa-fixes.css";')) errors.push("Final contrast fixes must load last among premium light layers.");
