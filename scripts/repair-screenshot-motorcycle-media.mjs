...
const targets = [
  ...
  { id:"honda-cb500-hornet-e-clutch", imageUrl:"https://www.honda.co.uk/content/dam/central/motorcycles/colour-picker/street/cb500_hornet/cb500_hornet_2026/nh-b01_graphite_black/K002_26YM_CB500HORNET_MT_NH-B01_GraphiteBlack_RhSide.png/jcr:content/renditions/c1_r.png", page:"https://www.honda.co.uk/motorcycles/range/street/cb500-hornet/overview.html", holder:"Honda", label:"Manufacturer product image · Honda CB500 Hornet" },

  { id:"suzuki-avenis", discover:{page:"https://www.suzukimotorcycle.co.in/product-details/avenis", needles:["GLOSSY SPARKLE BLACK / PEARL MIRA RED","Suzuki color Edition","AVENIS"]}, page:"https://www.suzukimotorcycle.co.in/product-details/avenis", holder:"Suzuki Motorcycle India", label:"Manufacturer product image · Suzuki Avenis" },
  { id:"suzuki-smash-fi", discover:{page:"https://motortrade.com.ph/motorcycles/suzuki-smash-fi/", needles:["SUZUKI SMASH FI","Smash FI"]}, page:"https://motortrade.com.ph/motorcycles/suzuki-smash-fi/", holder:"Motortrade / Suzuki", label:"Dealer product image · Suzuki Smash FI" },
  ...
  { id:"suzuki-gixxer-250", imageUrl:"https://mc.suzuki.com.ph/wp-content/uploads/2023/11/Gixxer250.png", page:"https://mc.suzuki.com.ph/motorcycles/backbone/gixxer-250/", holder:"Suzuki Philippines", label:"Manufacturer product image · Suzuki Gixxer 250" },
  { id:"suzuki-gixxer-sf250", imageUrl:"https://mc.suzuki.com.ph/wp-content/uploads/2023/11/Gixxer-SF250-17.png", page:"https://mc.suzuki.com.ph/motorcycles/backbone/gixxer-sf-250/", holder:"Suzuki Philippines", label:"Manufacturer product image · Suzuki Gixxer SF250" },
  ...
  { id:"suzuki-dr160", discover:{page:"https://mc.suzuki.com.ph/motorcycles/backbone/dr-160/", needles:["Solid Pure Black","DR160","DR 160"]}, page:"https://mc.suzuki.com.ph/motorcycles/backbone/dr-160/", holder:"Suzuki Philippines", label:"Manufacturer product image · Suzuki DR160" },
  ...
  { id:"suzuki-burgman-400", imageUrl:"https://mc.suzuki.com.ph/wp-content/uploads/2023/11/Burgman-400.png", page:"https://mc.suzuki.com.ph/motorcycles/big-bike/burgman-400/", holder:"Suzuki Philippines", label:"Manufacturer product image · Suzuki Burgman 400" },
  ...
  { id:"motorstar-xplorer-250r", current:true },
  ...
  { id:"royal-enfield-hunter-350", imageUrl:"https://www.royalenfield.com/content/dam/royal-enfield-revamp/header/shop/configure/hunter-350.webp", page:"https://www.royalenfield.com/in/en/motorcycles/hunter-350/", holder:"Royal Enfield", label:"Manufacturer product image · Royal Enfield Hunter 350" },
  ...
  { id:"bmw-g-310-gs", current:true },
  { id:"bmw-g-310-r", imageUrl:"https://www.bmwmotorrad.com.ph/content/dam/bmwmotorradnsc/common/multiimages/images/models/roadster/g310r-2020/2023/productstage/nsc-g310r-P0N2L-multiimage-2560x1440.jpg.asset.1732605080282.jpg", page:"https://www.bmwmotorrad.com.ph/en/models/roadster/g310r.html", holder:"BMW Motorrad", label:"Manufacturer product image · BMW G 310 R" },
  { id:"bmw-r-1300-gs", current:true },
...
async function fetchImage(url,referer) {
  ...
  if(meta.width<280 || meta.height<180) throw new Error("Source too small "+meta.width+"x"+meta.height+" "+url);
