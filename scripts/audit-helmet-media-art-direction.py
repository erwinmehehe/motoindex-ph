...
def main() -> int:
    ...
    print(f"Helmet art-direction audit: {len(files)} visible local WebPs checked.")
    if warnings:
    ...
    print("Helmet art-direction audit passed: pure-white borders, safe margins, and usable subject scale.")
    return 0
