...
const required = [
  ...
  ["lib/garageDocumentStore.ts", ["motoindex-garage-documents-v1", "indexedDB.open", "application/pdf", "image/jpeg", "GARAGE_DOCUMENT_ATTACHMENT_MAX_BYTES", "10 MB or smaller", "deleteGarageDocumentAttachments"]],
...
if (!documentStore.includes("10 * 1024 * 1024") || !documentStore.includes("ALLOWED_TYPES")) {
