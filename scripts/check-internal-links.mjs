...
for(const [route,file] of staticRoutes){
  if(route==="/"||route==="/ads.txt"||route.startsWith("/sitemaps/")||route.startsWith("/contact")||route.startsWith("/corrections")||route.startsWith("/search")||route.startsWith("/used-motorcycles")||route.startsWith("/price-alerts")||route.startsWith("/catalog")||route.startsWith("/deals")||route.startsWith("/sellers"))continue;
