...
console.log(`Internal-link audit passed: ${patterns.length} page route patterns checked; ${sources.length} source files scanned; no broken literal/template routes or static indexable orphans.`);
