...
if (!accessoryRoot.includes("/accessories/top-box") || !accessoryRoot.includes("/accessories/phone-holders") || !accessoryRoot.includes("/accessories/intercoms") || !accessoryRoot.includes("/accessories/rain-gear")) {
