...
export const recommendationGuides: RecommendationGuide[] = [
  {
    ...
    directAnswer: "Looking for a motorcycle below ₱100,000? MotoIndex tracks current motorcycles whose published starting price falls below ₱100,000 and compares them using measurable specifications instead of assuming the cheapest model is automatically the right choice.",
    ...
    orderLabel: "Rank",
    sourcePolicy: "Published prices come from dated manufacturer, dealer or comparison-site checks. Specifications come from each model's dated source-backed record; conflicting live-market prices are shown as a range rather than averaged.",
  ...
  },
  {
    ...
    directAnswer: "These are current automatic motorcycles in the MotoIndex database with an published starting price below ₱100,000. Price comes first, while weight and seat height stay visible because both can matter in everyday stop-and-go riding.",
    ...
    orderLabel: "Rank",
    sourcePolicy: "Published prices use dated live-market checks where available; specifications and transmission classification come from the source-backed model record.",
  ...
  },
  {
    ...
    directAnswer: "There is no single best scooter for every rider. MotoIndex compares current scooters using published price, engine size, curb weight, seat height, tank capacity, braking equipment and available fuel-economy figures so you can choose around your own priorities.",
    inclusionRules: ["Scooter category in the current MotoIndex motorcycle dataset", "Current Philippine-market motorcycle"],
  ...
  },
  {
    ...
    tieBreakers: ["Lower curb weight"],
    orderLabel: "Rank",
    sourcePolicy: "ABS wording, trim information and core specifications come from source-backed model records; published prices come from dated live-market checks where available.",
  ...
  },
  {
    ...
    orderLabel: "Rank",
    sourcePolicy: "Published km/L values and specifications come from dated source-backed model records; published prices come from dated market checks. Theoretical range is calculated as published km/L × tank capacity.",
  ...
  },
  {
    ...
    tieBreakers: ["Lower curb weight"],
    orderLabel: "Price order",
    sourcePolicy: "Published prices use dated market checks; power, torque, dimensions, transmission and braking details come from each source-backed model record.",
  ...
  },
  {
    ...
    sourcePolicy: "Seat height, curb weight, ground clearance and other specifications come from dated source-backed model records; published prices come from current market checks where available.",
  ...
  },
  {
    ...
    tieBreakers: ["Lower curb weight"],
    orderLabel: "Price order",
    sourcePolicy: "Published prices come from dated checks; engine, output, dimensions and braking details come from source-backed model records.",
  ...
  },
  {
    ...
    tieBreakers: ["Lower curb weight"],
    orderLabel: "Price order",
    sourcePolicy: "Published prices use dated checks; specifications and ground-clearance figures come from each model's source-backed record when available.",
  ...
  },
  {
    ...
    directAnswer: "This guide filters current Philippine-market scooter records to models with an published starting price of ₱150,000 or less. It orders them by price and keeps seat height, weight, braking equipment and published fuel economy visible so the budget does not become the only buying criterion.",
    ...
    orderLabel: "Price order",
    sourcePolicy: "Published prices come from dated manufacturer, dealer or comparison-site checks. Specifications come from each model's source-backed record.",
  ...
  },
  {
    ...
    tieBreakers: ["Lower curb weight"],
    orderLabel: "Price order",
    sourcePolicy: "Published prices use dated market checks; engine, output, dimensions and braking data come from source-backed model records.",
  ...
  },
{
    ...
    tieBreakers: ["Lower curb weight", "Lower seat height"],
    orderLabel: "Price order",
    sourcePolicy: "Published prices use dated Philippine manufacturer, dealer or comparison-site checks. Core specifications come from each model's source-backed record.",
...

  {
    ...
    tieBreakers: ["Lower curb weight", "Lower seat height"],
    orderLabel: "Price order",
    sourcePolicy: "Published prices use dated Philippine manufacturer, dealer or comparison-site checks. Core specifications come from each source-backed model record.",
  ...
  },
  {
    ...
    directAnswer: "This guide shows current motorcycles with an published starting price below ₱80,000 and compares the practical differences that matter after price.",
