...
export const recommendationGuides: RecommendationGuide[] = [
  ...
  },
  {
    ...
    directAnswer: "There is no single best scooter for every rider. Compare current scooters by price, engine size, curb weight, seat height, tank capacity, braking and available fuel-economy figures, then choose around your own priorities.",
    inclusionRules: ["Scooter category in the current Philippine motorcycle coverage", "Current Philippine-market motorcycle"],
    orderingRule: "Published starting price from lowest to highest for display only.",
    tieBreakers: ["Lower curb weight"],
    orderLabel: "Price order",
    sourcePolicy: "Scooter prices use dated observed market checks; dimensions, engine, brakes and fuel figures come from model-specific model records.",
    caveats: ["The best scooter depends on budget, rider fit, traffic, passenger needs and the exact variant.", "Handling and comfort claims require riding data that are not captured by basic specifications."],
    tableColumns: ["price", "engine", "transmission", "weight", "seat", "abs", "tank", "economy"],
    ...
    faqQuestions: ["Which scooters have the lowest published starting prices?", "Which scooters have ABS?", "Which scooters have lower seat heights?", "Which scooters have published fuel-economy figures?", "What should I compare before choosing a scooter?"],
  ...
  },
{
...

  {
    ...
    description: "Compare current Yamaha scooters in the Philippines by published price, engine size, curb weight, seat height, ABS, fuel economy and tank capacity.",
    ...
    directAnswer: "This guide filters MotoIndex to current, model-specific Yamaha scooters and compares their observed Philippine prices with published engine, weight, seat-height, braking and fuel data.",
    inclusionRules: ["Make is Yamaha", "Category contains scooter", "Current Philippine-market motorcycle"],
    orderingRule: "Published starting price from lowest to highest.",
    tieBreakers: ["Lower curb weight", "Lower seat height"],
    orderLabel: "Price order",
    sourcePolicy: "Published prices use dated Philippine manufacturer, dealer or comparison-site checks. Core specifications come from each model-specific model record.",
    ...
    faqQuestions: ["What Yamaha scooters are available in the Philippines?", "Which Yamaha scooter has the lowest published price?", "Which Yamaha scooter is lightest?", "Which Yamaha scooter has the lowest seat?", "Which Yamaha scooters list ABS?"],
  ...
  },
  {
    ...
    description: "Compare current Honda scooters in the Philippines by published price, engine size, weight, seat height, ABS, fuel economy and fuel-tank capacity.",
    ...
    directAnswer: "This page compares current Honda scooter records using dated Philippine prices and model-specific engine, weight, seat-height, fuel and braking specifications.",
    inclusionRules: ["Make is Honda", "Category contains scooter", "Current Philippine-market motorcycle"],
    orderingRule: "Published starting price from lowest to highest.",
    tieBreakers: ["Lower curb weight", "Lower seat height"],
    orderLabel: "Price order",
    sourcePolicy: "Published prices use dated Philippine sources; specifications come from the stored model-level evidence used by each MotoIndex page.",
    ...
    faqQuestions: ["What Honda scooters are available in the Philippines?", "Which Honda scooter has the lowest published price?", "Which Honda scooter is lightest?", "Which Honda scooter has the lowest seat?", "Which Honda scooters list ABS?"],
