...
export const motorcycles: Motorcycle[] = [
  ...
  {
    id: "yamaha-mt-07",
    alsoKnownAs: ["Yamaha MT07", "MT 07"],
    make: "Yamaha",
    makeSlug: "yamaha",
    model: "MT-07",
    slug: "mt-07",
    generation: "Current Philippine Sport Machine",
    marketStatus: "current",
    category: "Naked street bike",
    srp: 0,
    engineCc: 690,
    ...
    frontTire: "120/70-17",
    rearTire: "180/55-17",
    abs: "ABS equipment should be confirmed against the exact Philippine unit",
    colors: [],
    searchVolume: 0,
    keywordDifficulty: 0,
    sourceLabel: "Yamaha Motor Philippines official dealer network current Sport Machine catalog",
    sourceUrl: "https://find-dealer.yamaha-motor.com.ph/",
    verifiedAt: "2026-09-20",
    freshness: "review",
    priceContext: "Yamaha's official Philippine dealer network currently surfaces the MT-07 and identifies its 690cc CP2 engine. MotoIndex has not verified a current official Philippine SRP or complete local specification set, so pricing is intentionally not asserted.",
    transmission: "Manual",
    summary: "690cc CP2 hyper-naked motorcycle currently surfaced by Yamaha's official Philippine dealer network; local price and full specifications remain under verification."
  },
  {
    id: "yamaha-xsr700",
    alsoKnownAs: ["Yamaha XSR 700", "XSR 700"],
    make: "Yamaha",
    makeSlug: "yamaha",
    model: "XSR700",
    slug: "xsr700",
    ...
    verifiedAt: "2026-09-20",
    freshness: "review",
    priceContext: "Yamaha's official Philippine dealer network currently surfaces the XSR700. MotoIndex has not verified a current official Philippine SRP or complete local specification set, so pricing is intentionally not asserted.",
    transmission: "Manual",
    summary: "689cc retro Sport Machine currently surfaced by Yamaha's official Philippine dealer network; local price and full specifications remain under verification."
  },
  {
    id: "yamaha-yzf-r1m",
