...
export const recommendationGuides: RecommendationGuide[] = [
  ...
  },
  {
    ...
    quickPicks: [{label:"Lowest price",metric:"price"},{label:"Lightest",metric:"weight"},{label:"Lowest seat",metric:"seat"},{label:"Highest ground-clearance class",metric:"engine"},{label:"Largest fuel tank",metric:"tank"}],
