...
export const recommendationGuides: RecommendationGuide[] = [
  ...
  },
  {
    ...
    description: "Compare current dual-sport motorcycles in the Philippines by published price, engine, weight, seat height, ground clearance and braking equipment.",
    ...
    directAnswer: "MotoIndex compares current dual-sport motorcycles using model-specific price, engine, weight, seat-height, ground-clearance and braking records so the trade-offs stay visible.",
    inclusionRules: ["Category is dual-sport", "Current Philippine-market motorcycle"],
    orderingRule: "Published starting price from lowest to highest.",
    tieBreakers: ["Lower curb weight"],
    orderLabel: "Price order",
    sourcePolicy: "Published prices use dated checks; specifications and ground-clearance figures come from each model's model-specific record when available.",
    ...
    faqQuestions: ["What dual-sport motorcycles are available in the Philippines?", "Which dual-sport bike has the lowest published price?", "Which dual-sport motorcycle is lightest?", "Which has the lowest seat?", "What should I compare for road and trail use?"],
