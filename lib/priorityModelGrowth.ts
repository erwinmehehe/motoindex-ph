...
const profiles: Record<string, PriorityModelGrowthProfile> = {
  ...
  "kawasaki-ninja-h2": {
    ...
    seoDescription: "Kawasaki Ninja H2 Carbon price in the Philippines, 998cc supercharged specs, 231 hp, seat height, weight, ownership costs and alternatives.",
  ...
  "honda-rebel-1100": {
    ...
    seoDescription: "Honda Rebel 1100 price in the Philippines, 1083cc twin specs, DCT, 690mm seat, weight, ownership costs, financing context and alternatives.",
