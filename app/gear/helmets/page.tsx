...
export default function HelmetsPage(){
  ...
  return <section className="page shell helmet-hub-page">
    ...
    <div className="section-head inline-head helmet-hub-section-head"><div><span className="section-kicker">Popular comparisons</span><h2>Compare before you buy</h2><p>Side-by-side research using verified catalog records, not paid rankings.</p></div><Link href="/gear/helmets/compare">Compare exact models →</Link></div>
    ...
    <div className="section-head inline-head helmet-hub-section-head"><div><span className="section-kicker">Browse by brand</span><h2>Helmet brands</h2><p>Open an indexable brand page to compare its verified models, prices and documented features.</p></div><Link href="/gear/helmets/brands">Compare all brands →</Link></div>
