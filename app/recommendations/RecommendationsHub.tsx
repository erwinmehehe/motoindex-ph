  ...
  return <section className="recommendations-v2">
    ...
    <main className="shell rec-content">
      ...
      <section id="400cc" className="rec-section rec-data-section rec-400cc-section">
        <div className="rec-section-head"><div><span>400cc and above</span><h2>Start with three current big-bike comparisons.</h2><p>Use recorded displacement as a shortlist filter, then compare price, weight, seat height, power and braking before choosing a model.</p></div><Link href="/recommendations/motorcycles-400cc-plus-philippines">Open the full 400cc+ guide →</Link></div>
