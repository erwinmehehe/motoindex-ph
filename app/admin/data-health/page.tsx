...
export default function DataHealthPage(){
  ...
  return <section className="page shell">
    <div className="page-head"><h1>Data health & research queue</h1><p>Production data-quality dashboard for public motorcycle records. It prioritizes stale sources, thin price coverage, unresolved price ranges and missing ownership data. This route remains protected by middleware authentication and noindex headers.</p><div className="hero-actions"><a className="button small" href="/admin/growth">Growth dashboard</a><a className="button ghost small" href="/admin/dealer-leads">Dealer leads</a><a className="button ghost small" href="/admin/dealer-applications">Dealer applications</a><a className="button ghost small" href="/admin/used-listings">Used listings</a><a className="button ghost small" href="/admin/offers-review">Offers</a><a className="button ghost small" href="/admin/affiliate-links">Affiliate links</a></div></div>
