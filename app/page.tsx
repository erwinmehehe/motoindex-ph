...
const startPoints = [
  ["01", "Scooters", "Automatic choices for traffic, errands and everyday commuting.", "/recommendations#scooters"],
  ["02", "Daily commuters", "Practical motorcycles for frequent Philippine road use.", "/recommendations#commuting"],
  ["03", "Beginner friendly", "Approachable choices before stepping into more bike than you need.", "/recommendations#rider-fit"],
  ["04", "400cc and above", "Bigger-displacement options with the specs that matter side by side.", "/recommendations#400cc"],
      ...
      <section className="mi-hero" aria-labelledby="mi-home-title">
        ...
        <div className="shell mi-hero-layout">
          <div className="mi-hero-copy">
            ...
            <div className="mi-popular"><b>Popular:</b><Link href="/recommendations#scooters">Automatic scooters</Link><Link href="/recommendations#commuting">Daily commuters</Link><Link href="/recommendations#400cc">400cc+</Link><Link href="/motorcycles?budget=under100">Under ₱100K ↗</Link></div>
            <div className="mi-trust"><span>✓ No signup needed</span><span>✓ {siteStats.currentMotorcycles} current models</span><span>✓ Save your shortlist</span></div>
          </div>
